...
const MoviePage = () => {
  ...
  const [url, setUrl] = useState(
    `https://api.themoviedb.org/3/movie/popular?api_key=2fdfc54a0081fa603e94434cd55c101b&page=${next}"
  );
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        `https://api.themoviedb.org/3/search/movie?api_key=2fdfc54a0081fa603e94434cd55c101b&query=${filterDebounce}`
      );
    } else {
      setUrl(
